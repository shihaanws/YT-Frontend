...
function Notification() {
        const data = [
    
            {
              ...
              {
                image: 'https://upload.wikimedia.org/wikipedia/commons/3/33/Vanamo_Logo.png',
                message: 'Krish Naik premiering now: Inderpreet Successful Career Transition From A Freshers To Data Science With 5 Job Offers 3 hours ago',
                detailPage: '/',
